...
function IdPSelectLanguages(){
    ...
    'en': {
        ...
        'idpPreferred.label': 'Choose your school or organization below:',
        'idpEntry.label': 'Or enter another:',
        'idpEntry.NoPreferred.label': 'Enter your organization\'s name',
        'idpList.label': 'Or select from the list below:',
        'idpList.NoPreferred.label': 'Select your organization from the list below and use those credentials to log in to GENI:',
        'idpList.defaultOptionLabel': 'Select one...',
        'idpList.showList' : 'Show a list of organizations',
        'idpList.showSearch' : 'Allow me to enter the organization',
